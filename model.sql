...
CREATE TABLE "pagamento_compra" (
  "id_pagamento_compra" int4 NOT NULL,
  "id_compra" int4,
  "id_forma_de_pagamento" int4,
  "parcelas" int4,
  "prazo" varchar(20),
  "status" char(2),
...
CREATE TABLE "pagamento_venda" (
  "id_pagamento_venda" int4 NOT NULL,
  "id_venda" int4,
  "id_forma_pagamento" int4,
...
CREATE TABLE "parcelas" (
	...
	"id_pagamento_venda" int4,
	"numero_da_parcela" int4,
